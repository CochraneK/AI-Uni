...
export default function Game() {
  ...
  return (
    <>
      ...
      <div className="mx-auto w-full max-w grid grid-rows-[minmax(360px,52vh)_minmax(480px,1fr)] lg:grid-rows-[1fr] lg:grid-cols-[1fr_auto] lg:grow max-w-[1400px] min-h-[620px] game-frame">
        {/* Game area */}
