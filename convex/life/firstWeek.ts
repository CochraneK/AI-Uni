...
export const universityFirstWeek: FirstWeekDay[] = [
  {
    day: 1,
    title: '来到这里',
    ordinaryGoals: ['完成报到', '进入宿舍', '认识至少一名室友', '第一次自由逛校园'],
    recommendedLocations: ['south_gate', 'dormitory', 'cafeteria'],
    eventCategories: ['education', 'social', 'family'],
    developmentalTasks: ['autonomy_from_family', 'belonging'],
    researchDensity: 'low',
    closingBeat: '第一次在新的宿舍准备睡觉。',
  },
  {
    day: 2,
    title: '第一次正式上课',
    ordinaryGoals: ['按时找到教室', '完成第一天课程', '和同学一起吃饭'],
    recommendedLocations: ['siyuan_building', 'cafeteria', 'library'],
    eventCategories: ['education', 'social'],
    developmentalTasks: ['education_commitment', 'belonging'],
    researchDensity: 'low',
    closingBeat: '开始记住一些人的名字。',
  },
  {
    day: 3,
    title: '第一次合作',
    ordinaryGoals: ['加入一次小组任务', '决定分工', '安排下一次碰面'],
    recommendedLocations: ['library', 'siyuan_building'],
    eventCategories: ['education', 'social'],
  ...
  },
  {
    day: 4,
    title: '试试看别的生活',
    ordinaryGoals: ['看看社团和校园活动', '至少探索一个不熟悉的选项', '决定是否报名'],
    recommendedLocations: ['student_center', 'sports_field', 'ming_lake'],
  ...
  },
  {
    ...
    recommendedLocations: ['student_center', 'south_gate'],
  ...
  },
  {
    ...
    recommendedLocations: ['ming_lake', 'library', 'dormitory'],
