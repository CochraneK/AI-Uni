  ...
  scenarios: [
    {
      ...
      estimatedMinutes: 30,
      timeWindows: [{ start: '08:00', end: '10:00', label: '早餐时段' }],
    ...
    },
    {
      ...
      estimatedMinutes: 30,
      timeWindows: [{ start: '09:00', end: '22:30', label: '图书馆开放时段' }],
    ...
    },
    {
      ...
      estimatedMinutes: 30,
      timeWindows: [{ start: '08:00', end: '21:30', label: '白天与晚间散步' }],
    ...
    },
    {
      ...
      estimatedMinutes: 25,
      timeWindows: [{ start: '08:00', end: '22:30', label: '住宿区日常' }],
      npcRoles: ['roommate'],
      hiddenTargets: [],
      safetyLevel: 'ordinary',
      researchUse: 'none',
    ...
    },
    {
      ...
      estimatedMinutes: 45,
      timeWindows: [{ start: '16:00', end: '21:30', label: '课后运动' }],
      npcRoles: ['friend', 'classmate'],
      hiddenTargets: [],
      safetyLevel: 'ordinary',
      researchUse: 'none',
    ...
    },
    {
      ...
      estimatedMinutes: 20,
      timeWindows: [{ start: '08:00', end: '22:00', label: '日间会合' }],
      npcRoles: ['friend', 'classmate'],
      hiddenTargets: [],
      safetyLevel: 'ordinary',
      researchUse: 'none',
    ...
    },
    {
      ...
      estimatedMinutes: 45,
      timeWindows: [{ start: '16:00', end: '20:30', label: '课后社团时段' }],
    ...
    },
    {
      ...
      estimatedMinutes: 45,
      timeWindows: [{ start: '13:00', end: '21:30', label: '课后小组任务' }],
    ...
    },
    {
      ...
      estimatedMinutes: 25,
      timeWindows: [{ start: '08:30', end: '12:00', label: '上午课程时段' }],
    ...
    },
    {
      ...
      estimatedMinutes: 45,
      timeWindows: [{ start: '09:00', end: '17:00', label: '课程与展示时段' }],
